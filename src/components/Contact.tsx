...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-gray-50 px-4 md:px-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <a href="mailto:tmon396@gmail.com" className="text-gray-600 hover:text-blue-500 transition-colors">
                    tmon396@gmail.com
                  </a>
                </div>
              </div>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full py-3 px-6 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors disabled:bg-blue-400 flex items-center justify-center gap-2"
              >
                {isSubmitting ? (
                  <>Processing...</>
                ) : (
